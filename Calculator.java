...
class Calculator {
	...
	private void initialize() {
		...
		frmCalculator.setTitle(" Scientific Calculator Internsavy");
		frmCalculator.getContentPane().setBackground(new Color(172, 170, 255));
		frmCalculator.getContentPane().setFont(new Font("Arial Black", Font.PLAIN, 15));
		...
		button12.setBackground(new Color(230, 230, 230));
		...
		button13.setBackground(new Color(230, 230, 230));
		...
		button14.setBackground(new Color(230, 230, 230));
		...
		button17.setBackground(new Color(230, 230, 230));
		...
		button18.setBackground(new Color(230, 230, 230));
		...
		button19.setBackground(new Color(230, 230, 230));
		...
		button22.setBackground(new Color(230, 230, 230));
		...
		button23.setBackground(new Color(230, 230, 230));
		...
		button24.setBackground(new Color(230, 230, 230));
		...
		button28.setBackground(new Color(230, 230, 230));
